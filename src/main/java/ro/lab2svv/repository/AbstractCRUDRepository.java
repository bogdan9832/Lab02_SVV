...
import ro.lab2svv.domain.HasID;
import ro.lab2svv.validation.ValidationException;
...
public abstract class AbstractCRUDRepository<ID, E extends HasID<ID>> implements CRUDRepository<ID, E>{
    ...
    @Override
    public E save(E entity) throws ValidationException, ValidationException, ValidationException {
        try {
            validator.validate(entity);
            return entities.putIfAbsent(entity.getID(), entity) == null ? entity : null;
        }
